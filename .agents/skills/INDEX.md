...
| `architecture-design` | medium | **Software architecture work — system design, docs/architecture.md, pattern selection, migration, ADR writing, audits, API/data/security architecture, and fitness functions.** Responsibility split, data ownership, C4 mermaid diagrams, 33 architecture patterns catalog, scenario workflows, ADR templates. | Minor code changes that don't affect architecture |
