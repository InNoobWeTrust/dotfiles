...
| `web-qa-audit` | medium | Executable web QA/QC: structured browser audits, QA-scoped spot checks with evidence contracts, and planning/materializing durable E2E or a11y/regression suites | The task is only heuristic review of an artifact with no executable QA need |
