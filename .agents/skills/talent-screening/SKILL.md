...
# Talent Screening & Candidate Evaluation

A structured methodology to systematically analyze job descriptions, verify candidate credentials, run OSINT background investigations, perform multi-directional risk assessments, and produce data-driven recommendations.

> [!CAUTION]
> **Jurisdiction and Privacy compliance**: referenced sources, OSINT practices, and data retention requirements vary by country (e.g. company registries, labor law, GDPR, CCPA). Always align your investigation methods with local legal and regulatory boundaries.
