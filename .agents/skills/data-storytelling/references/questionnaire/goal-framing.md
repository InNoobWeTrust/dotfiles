...
Use this when no upstream investigation was run, when its required fields are missing, or when the user has not provided enough context to align the analysis.
