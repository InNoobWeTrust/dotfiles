...
Use this when `systematic-investigation` was not run, when its required fields are missing, or when the user has not provided enough context to align the analysis.
