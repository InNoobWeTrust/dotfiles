...
- **questionnaire/goal-framing.md**: Fallback questionnaire for gathering goal, audience, threshold, and other context when no upstream investigation is available.
