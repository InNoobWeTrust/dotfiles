...
(see `.agents/skills/requirements-driven-dev/references/core/adversarial-protocol.md` for the full protocol).
...
- **Template**: See `.agents/skills/requirements-driven-dev/references/templates/prd.md`
- **Rules**: See `.agents/rules/requirements-driven-dev/prd.md`
...
- **Template**: See `.agents/skills/requirements-driven-dev/references/templates/trd.md`
- **Rules**: See `.agents/rules/requirements-driven-dev/trd.md`
...
- **Template**: See `.agents/skills/requirements-driven-dev/references/templates/behavior-spec.md`
- **Rules**: See `.agents/rules/requirements-driven-dev/bdd.md`
...
technology stack, conventions, and rules that all implementation sessions
...
- Follow execution rules in `.agents/rules/requirements-driven-dev/execution.md`
...
- Template: See `.agents/skills/requirements-driven-dev/references/templates/verification-spec.md`
...
`.agents/skills/requirements-driven-dev/references/core/adversarial-protocol.md`.
...
See `.agents/skills/requirements-driven-dev/references/core/adversarial-protocol.md` for the full adversarial
...
Every BDD spec contains a **Traceability Matrix** section (see `.agents/skills/requirements-driven-dev/references/templates/behavior-spec.md`).
...
- **Template**: See `.agents/skills/requirements-driven-dev/references/templates/changelog-entry.md`
- **Rules**: See `.agents/rules/requirements-driven-dev/changelog.md`
...
- Rules: See `.agents/rules/requirements-driven-dev/commit.md`
